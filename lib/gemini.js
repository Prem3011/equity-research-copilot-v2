...
All number values in debt maturity and liquidity should be in billions (${currency}). For liquidity, use the MOST RECENT fiscal year data. Sources and Uses values should all be positive numbers.
...
Debt maturity and liquidity values in billions. For liquidity, use the MOST RECENT fiscal year data. Sources and Uses values should all be positive numbers.
Segment and geography percentages must sum to 100.
