...
const INDIAN_TICKERS = [
  ...
  "KOTAKBANK","ADANIENT","TATAMOTORS","TATASTEEL","ICICIBANK","ASIANPAINT",
...

{
  "profile": {
    ...
    "change": daily change as number,
    "changePercentage": daily change percent as number,
    "marketCap": market cap as raw number
  },
  "years": [
    {
      "year": "2020 or 2021",
