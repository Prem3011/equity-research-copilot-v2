...
export async function fetchGeminiCombined(ticker, apiKey) {
  ...
  const gemini = {
    overview: raw.overview || "", risks: raw.risks || [],
    bullCase: raw.bullCase || "", bearCase: raw.bearCase || "",
    thesis: raw.thesis || "", outlook: raw.outlook || "Neutral",
    news: raw.news || [], segmentRevenue: raw.segmentRevenue || [],
